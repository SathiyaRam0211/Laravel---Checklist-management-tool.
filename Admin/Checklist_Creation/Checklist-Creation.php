...
<head>
    ...
    <title>Checklist-Creation</title>
</head>
<body>
...
<div class="main-section">
  <?php require_once "./checklist-creation-content.php"; ?>
</div>
<script>var session_name = "<?php echo $_SESSION['username']; ?>";</script>
<script src="https://code.jquery.com/jquery-3.5.1.js" integrity="sha256-QWo7LDvxbWT2tbbQ97B53yJnYU3WhH/C8ycbRAkjPDc=" crossorigin="anonymous"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ho+j7jyWK8fNQe+A12Hb8AhRq26LrZ/JpcUGGOn+Y7RsweNrtN/tE3MoK7ZeZDyx" crossorigin="anonymous"></script>
<script src="https://use.fontawesome.com/6f80b9c499.js"></script>
<script type="text/javascript"src="../../Asset/dashboard.js"></script>
<script type="text/javascript" src="create-checklist.js"></script>
</body>
</html>
